      ...
      var r = function (t, e) {
        ...
        T = function (t, e, o) {
          ...
          function d(e) {
            var o = r,
              i = n;
            return (r = n = void 0), (u = e), (s = t.apply(i, o));
          }
          function v(t) {
            var o = t - a;
            return void 0 === a || o >= e || o < 0 || (f && t - u >= i);
          }
          function y() {
            var t = M();
            if (v(t)) return _(t);
            c = setTimeout(
              ...
              (function (t) {
                var o = e - (t - a);
                return f ? P(o, i - (t - u)) : o;
              })(t)
            );
          }
          function _(t) {
            return (c = void 0), p && r ? d(t) : ((r = n = void 0), s);
          }
          function b() {
            var t = M(),
              o = v(t);
            if (((r = arguments), (n = this), (a = t), o)) {
              if (void 0 === c)
                return (function (t) {
                  return (u = t), (c = setTimeout(y, e)), h ? d(t) : s;
                })(a);
              if (f) return clearTimeout(c), (c = setTimeout(y, e)), d(a);
            }
            return void 0 === c && (c = setTimeout(y, e)), s;
          }
          return (
            (e = j(e) || 0),
            l(o) &&
              ((h = !!o.leading),
              (i = (f = "maxWait" in o) ? k(j(o.maxWait) || 0, e) : i),
            ...
            (t.prototype.render = function (t, e) {
              ...
              if (r || i) {
                ...
                this._ctx.clearRect(
                  ...
                  this._renderX(r),
                  this._renderY(i);
              } else C(this._canvas, { display: "none" });
            }),
      ...
      var L = /wheel|touch/,
        U = (function (t) {
          function e() {
            ...
            return (
              (e._glow = new z(e.scrollbar)),
              (e._bounce = new B(e.scrollbar)),
              (e._wheelScrollBack = { x: !1, y: !1 }),
              (e._lockWheel = { x: !1, y: !1 }),
              (e._touching = !1),
              (e._amplitude = { x: 0, y: 0 }),
              (e._position = { x: 0, y: 0 }),
              (e._releaseWheel = T(function () {
          ...
          return (
            ...
            (e.prototype.onUpdate = function () {
              this.options.effect === N.GLOW && this._glow.adjust();
            }),
            ...
            (e.prototype._absorbMomentum = function (t, e) {
              var o = this.options,
                ...
                n = this._amplitude;
              L.test(r) && (n[t] = S(e, -o.maxOverscroll, o.maxOverscroll));
            }),
            (e.prototype._addAmplitude = function (t, e) {
              ...
              (n[t] =
                0 === r.offset[t]
                  ? S(l, -o.maxOverscroll, 0)
                  : S(l, 0, o.maxOverscroll)),
                c && (i[t] = n[t]);
            }),
