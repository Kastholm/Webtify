...
class CreateParticles {
  constructor(scene, font, particleImg, camera, renderer) {
    ...
    scene.background = new THREE.Color(0xe9c46a);
    this.colorChange = new THREE.Color();

    this.buttom = false;

    this.data = {
      text: "Danmarks hurtigst\nvoksende Web Beraue",
      amount: 1500,
      particleSize: 1,
      particleColor: 0xfbfbfb,
      textSize: 6,
      area: 250,
      ease: 0.05,
    };
  ...
  render(level) {
    ...
    if (intersects.length > 0) {
      ...
      for (var i = 0, l = pos.count; i < l; i++) {
        ...
        this.colorChange.setHSL(20.5, 1, 1);
        coulors.setXYZ(
          i,
          this.colorChange.r,
          this.colorChange.g,
        ...
        if (this.buttom) {
          ...
          if (mouseDistance < this.data.area) {
            ...
            if (
              ...
              this.colorChange.setHSL(0.15, 1.0, 0.1);
              coulors.setXYZ(
                i,
                this.colorChange.r,
                this.colorChange.g,
  ...
  createText() {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        color: { value: new THREE.Color(0xfbfbfb) }, //Skrift farve
